    ...
    R: Read + Seek,
{
    ...
    current_data: Option<Vec<Sample>>,
    ...
    R: Read + Seek,
{
    ...
    pub fn new_with_settings(mut data: R, settings: &Settings) -> Result<Self, R> {
        ...
        let total_samples = total_duration.map(|dur| {
            ...
            (total_secs * sample_rate.get() as f64 * channels as f64).ceil() as u64
        });
    ...
    R: Read + Seek,
{
    ...
    fn try_seek(&mut self, pos: Duration) -> Result<(), SeekError> {
        ...
        let target_granule_pos = (target.as_secs_f64() * self.sample_rate().get() as f64) as u64;
