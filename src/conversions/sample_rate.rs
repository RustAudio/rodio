...
use crate::source::{Resample, ResampleConfig, SeekError};
use crate::{Sample, Source};
use std::time::Duration;

/// Iterator that converts from one sample rate to another, delegating to [`Resample`].
    ...
    I: Iterator<Item = Sample>,
{
    ...
    pub fn new(input: I, from: SampleRate, to: SampleRate, channels: ChannelCount) -> Self {
        ...
        // Use moderate chunk size - delay compensation will handle offset/latency
...
/// Used internally by SampleRateConverter to avoid requiring input to implement Source.
#[derive(Clone)]
    ...
    I: Iterator<Item = Sample>,
{
    ...
    fn current_span_len(&self) -> Option<usize> {
        // Use size_hint upper bound as span length if available
