...
use rodio::source::SoundPositions;
use rodio::Source;
...
fn main() {
    ...
    let mut positions = SoundPositions::new([0., 0., 0.], [-1., 0., 0.], [1., 0., 0.]);
    let sink = rodio::SpatialSink::try_new(&handle, positions.clone()).unwrap();
    ...
    for _ in 0..repeats {
        for _ in 0..num_steps {
            ...
            positions.emitter_position[0] += step_distance;
            sink.set_emitter_position(positions.emitter_position);
        }
